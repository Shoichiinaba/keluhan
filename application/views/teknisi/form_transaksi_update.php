...
<form method="post" action="<?php echo base_url();?>index.php/transaksi_c/update">
<div class="form-group">
<!--<label>ID Transaksi</label>
<input type="text" class="form-control" placeholder="Id Transaksi" required="" name="Id_trx" value="<?php echo $result['Id_trx'];?>">
</div>-->
<div class="form-group">
    <label >Nama Teknisi</label>
        ...
        <?php foreach ($teknisi as  $value) {
           if($value[id_teknisi]==$result['teknisi']){
                echo "<option value='$value[id_teknisi]' selected=''>$value[nama_teknisi]</option>";
               }
            else {
...
<input type="text" class="form-control" placeholder="Nama Komponen" required="" name="nama_komponen" value="<?php echo $result['nama_komponen'];?>">
</div>
<div class="form-group">
<label>Harga</label>
<input type="text" class="form-control" placeholder="Harga" required="" name="harga" value="<?php echo $result['harga'];?>">
</div>
<div class="form-group">
<label>Jumlah Komponen</label>
<input type="text" class="form-control" placeholder="Jumlah Komponen" required="" name="jumlah_komp" value="<?php echo $result['jumlah_komp'];?>">
<!--<div class="form-group">
<label>Total Harga</label>
<input type="text" class="form-control" placeholder="Total Harga" required="" name="total_harga value="<?php echo $result['total_harga'];?>">
</div>-->
<div class="form-group">
<label>Tanggal Pengerjaan</label>
<input type="text" class="form-control" placeholder="Tanggal Pengerjaan" required="" name="tgl_pengerjaan" value="<?php echo $result['tgl_pengerjaan'];?>">
</div>
<hr>
<button type="submit" class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-transfer"></i>&nbsp; Update</button>
</form>
</div>
</div>	
</div>
